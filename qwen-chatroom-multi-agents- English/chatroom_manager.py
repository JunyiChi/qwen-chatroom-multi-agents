...
class ChatroomManager:
    ...
    def extract_respond_to(self, text: str) -> list:
        ...
        # 1.1 Strong signal supplement: direct address at beginning, like "Max, what do you think"
        for name in names:
        ...
        # 3. Weak signal: default to responding to previous speaker
    ...
    def run(self):
        ...
        for round_num in range(self.rounds):
            ...
            for speaker in speakers:
                ...
                # Build context using structured memory
                ...
                # Add message to structured memory pool
